...
static void print_usage(const std::string& progname)
{
...
// TODO put to unnamed namespace
static std::string get_ether(const std::string& hardware_addr);
...
static unsigned get_hex_from_string(const std::string& s)
{
    unsigned hex{0};
